...
PROJECT_NAME ?= provider-goharbor
...
xpkg.build.provider-goharbor: do.build.images
...
#   You can check the basic implementation here: https://github.com/upbound/uptest/blob/main/internal/goharbors/01-delete.yaml.tmpl.
